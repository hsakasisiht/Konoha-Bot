...
// Your Genius API token - corrected to remove trailing dash
const API_TOKEN = "WAkdz9DKDnfKPRxMMjrfODpTqq9KrqHjLrKW2Q_Px9hqYJsUSv1H3WHGzEQmNwj-";
    ...
    async searchSong(query, limit = 10) {
        try {
            ...
            try {
                ...
                console.error("AZLyrics fallback search failed:", fallbackError.message);
            }
